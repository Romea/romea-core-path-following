...
#include \
  "romea_core_path_following/sliding_observer/SlidingObserverExtendedCinematicLyapunov.hpp"
...
PathFollowingSlidingObserverExtendedCinematicLyapunov<CommandType>::
...
//-----------------------------------------------------------------------------
template<typename CommandType>
ExtendedSlidings PathFollowingSlidingObserverExtendedCinematicLyapunov<CommandType>::computeSlidings(
...
//-----------------------------------------------------------------------------
template<typename CommandType>
void PathFollowingSlidingObserverExtendedCinematicLyapunov<CommandType>::reset()
{
  observer_.reset();
}
...
//-----------------------------------------------------------------------------
template<typename CommandType>
void PathFollowingSlidingObserverExtendedCinematicLyapunov<CommandType>::log(
...
template class PathFollowingSlidingObserverExtendedCinematicLyapunov<OneAxleSteeringCommand>;
template class PathFollowingSlidingObserverExtendedCinematicLyapunov<TwoAxleSteeringCommand>;
