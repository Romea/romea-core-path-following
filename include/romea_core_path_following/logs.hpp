...
#ifndef ROMEA_CORE_PATH_FOLLOWING__LOGS_HPP_
#define ROMEA_CORE_PATH_FOLLOWING__LOGS_HPP_
...
void log(SimpleFileLogger & logger, const PathMatchedPoint2D & parth_matched_point);
...
#endif  // ROMEA_CORE_PATH_FOLLOWING__LOGS_HPP_
